...
const StellarCore = () => {
    ...
    return (
        <Float speed={2} floatIntensity={1.5} rotationIntensity={1}>
            ...
            <Sparkles count={60} scale={6} size={2.5} speed={0.6} opacity={0.6} color="#60A5FA" />
            
            {/* Lighting */}
            <ambientLight intensity={0.3} />
            <directionalLight position={[5, 10, 5]} intensity={2} color="#ffffff" />
            <pointLight position={[0, 0, 0]} intensity={3} color="#2563EB" distance={6} />
        </Float>
    );
};
...
export default function GrowthSection() {
    return (
        <section className="bg-gradient-to-b from-[#050812] via-[#080b18] to-[#060a18] text-white py-24 px-6 md:px-10 lg:px-20 font-sans tracking-wide overflow-hidden">
            <motion.div
                ...
                <div className="flex flex-col items-center gap-14 lg:gap-20 w-full mt-10">
                    ...
                    <div className="flex flex-col xl:flex-row items-center justify-center w-full gap-12 lg:gap-16">
                        ...
                        <motion.div
                            ...
                            className="relative bg-[#0F1426] border border-[#1E293B] rounded-[1.8rem] p-10 md:p-12 w-full max-w-[420px] shadow-2xl text-center flex-shrink-0 transition-all hover:border-[#334155] z-10"
                        >
                            <div className="absolute -top-[14px] left-1/2 -translate-x-1/2 w-7 h-7 bg-[#2563EB] rounded-full shadow-[0_0_20px_rgba(37,99,235,0.9)] ring-[6px] ring-[#050812]"></div>
                        ...
                        >
                            <Canvas camera={{ position: [0, 0, 4.5], fov: 45 }}>
                                <StellarCore />
                                {/* Environment map to add cinematic HDR reflections onto the distorted core */}
                        ...
                        <motion.div
                            ...
                            className="relative bg-[#0F1426] border border-[#1E293B] rounded-[1.8rem] p-10 md:p-12 w-full max-w-[420px] shadow-2xl text-center flex-shrink-0 transition-all hover:border-[#334155] z-10"
                        >
                            <div className="absolute -top-[14px] left-1/2 -translate-x-1/2 w-7 h-7 bg-[#A855F7] rounded-full shadow-[0_0_20px_rgba(168,85,247,0.9)] ring-[6px] ring-[#050812]"></div>
                    ...
                    <motion.div
                        ...
                        className="relative bg-[#0F1426] border border-[#1E293B] rounded-[1.8rem] p-10 md:p-12 w-full max-w-[420px] shadow-2xl text-center transition-all hover:border-[#334155] z-10"
                    >
                        <div className="absolute -top-[14px] left-1/2 -translate-x-1/2 w-7 h-7 bg-[#2563EB] rounded-full shadow-[0_0_20px_rgba(37,99,235,0.9)] ring-[6px] ring-[#050812]"></div>
