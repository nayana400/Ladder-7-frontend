...
const About = () => {
    return (
        <div className="bg-[#1a365d] min-h-screen">
            ...
            <main>
                {/* 3D Animated Hero Section - High Fidelity Writing Effect */}
                <section className="relative h-[50vh] flex items-center justify-center overflow-hidden pt-20 bg-white">
                    <AboutScene />
                </section>

                {/* Brand Content Section */}
                <section className="py-24 bg-[#112240] relative z-10 border-t border-white/5">
                    <div className="container mx-auto px-6">
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-16 items-center">
                            ...
                            {/* Impact Metrics */}
                            <div className="bg-white/5 p-12 rounded-3xl border border-white/10 backdrop-blur-xl shadow-2xl">
                                <div className="grid grid-cols-2 gap-12">
                                    <div className="text-center group">
                                        <div className="text-5xl font-bold text-blue-400 mb-2 transition-transform group-hover:scale-110">500+</div>
                                        <div className="text-gray-400 text-sm font-semibold uppercase tracking-widest">Students</div>
                                    </div>
                                    <div className="text-center group">
                                        <div className="text-5xl font-bold text-purple-400 mb-2 transition-transform group-hover:scale-110">50+</div>
                                        <div className="text-gray-400 text-sm font-semibold uppercase tracking-widest">Programs</div>
                                    </div>
                                    <div className="text-center group">
                                        <div className="text-5xl font-bold text-teal-400 mb-2 transition-transform group-hover:scale-110">10+</div>
                                        <div className="text-gray-400 text-sm font-semibold uppercase tracking-widest">Partners</div>
                                    </div>
                                    <div className="text-center group">
                                        <div className="text-5xl font-bold text-pink-400 mb-2 transition-transform group-hover:scale-110">95%</div>
